...
This section describes the code contained in the Appendix. This code is largely based on the implementation of the [Innohead team](sites.google.com/a/innohead.com/wiki/Home/Python/reinforcement-learning---tic-tac-toe0). Although, we adjusted some parameters and added others to augment the depth of our experimental analysis. We also enhanced the GUI.
